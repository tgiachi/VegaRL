...
public sealed class ImplicitScaleOffset : ImplicitModuleBase
{
    ...
    public override double Get(double x, double y, double z) =>
        Source.Get(x, y, z) * Scale.Get(x, y, z) + Offset.Get(x, y, z);

    public override double Get(double x, double y, double z, double w) =>
        Source.Get(x, y, z, w) * Scale.Get(x, y, z, w) + Offset.Get(x, y, z, w);

    public override double Get(double x, double y, double z, double w, double u, double v) =>
        Source.Get(x, y, z, w, u, v) * Scale.Get(x, y, z, w, u, v) + Offset.Get(x, y, z, w, u, v);
}
