...
public sealed class ImplicitClamp : ImplicitModuleBase
{
    ...
    public override double Get(double x, double y, double z) => Utilities.Clamp(
        Source.Get(x, y, z),
        Low.Get(x, y, z),
        High.Get(x, y, z)
    );

    public override double Get(double x, double y, double z, double w) => Utilities.Clamp(
        Source.Get(x, y, z, w),
        Low.Get(x, y, z, w),
        High.Get(x, y, z, w)
    );

    public override double Get(double x, double y, double z, double w, double u, double v) => Utilities.Clamp(
        Source.Get(x, y, z, w, u, v),
        Low.Get(x, y, z, w, u, v),
