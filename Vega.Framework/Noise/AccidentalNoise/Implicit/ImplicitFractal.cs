...
public sealed class ImplicitFractal : ImplicitModuleBase
{
    ...
    public ImplicitFractal(
        FractalType fractalType, BasisType basisType, InterpolationType interpolationType, Int32 octaves, double frequency,
        Int32 seed = 0
    )
    {
        this.seed = seed;
    ...
    public override Double Get(Double x, Double y)
    {
        ...
        return MathsHelper.Clamp(v, -1.0, 1.0);
    }
    ...
    public override Double Get(Double x, Double y, Double z)
    {
        ...
        return MathsHelper.Clamp(val, -1.0, 1.0);
    }
