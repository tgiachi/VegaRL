...
public sealed class ImplicitPow : ImplicitModuleBase
{
    ...
    public override double Get(double x, double y, double z, double w) =>
        Math.Pow(Source.Get(x, y, z, w), Power.Get(x, y, z, w));

    public override double Get(double x, double y, double z, double w, double u, double v) => Math.Pow(
        Source.Get(x, y, z, w, u, v),
        Power.Get(x, y, z, w, u, v)
    );
}
